...
puts "In a predictable result the #{slow_poke} beat the #{speedy}"# YOUR CODE HERE
...
puts "#{name} will one day get his #{year}, #{car} back that he had to sell when he changed jobs."
